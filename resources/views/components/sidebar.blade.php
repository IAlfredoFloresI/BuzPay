<div id="layoutSidenav_nav">
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link text-white" href="index.html">
                            <div class="sb-nav-link-icon text-white"><svg xmlns="http://www.w3.org/2000/svg" width="16"
                        ...
                        <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne"
                            ...
                            <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link text-white" href="recargar_tarjeta.html">Recargar Tarjeta</a>
                                <a class="nav-link text-white" href="consultar_tarjeta.html">Consultar Datos
                                    Tarjeta</a>
                            </nav>
                        </div>
                        <a class="nav-link collapsed text-white" href="#" data-bs-toggle="collapse"
                        ...
                        <div class="collapse" id="collapsePages" aria-labelledby="headingOne"
                            ...
                            <nav class="sb-sidenav-menu-nested nav">
                                ...
                                <a class="nav-link text-white" href="register.html">Registrate</a>
                            </nav>
                        </div>
                        <div class="sb-sidenav-menu-heading text-white">Observasiones</div>
                        ...
                        <a class="nav-link text-white" href="cierre_caja.html">
                            <div class="sb-nav-link-icon text-white">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                ...
                <div class="sb-sidenav-footer text-white">
                    <div class="small text-white">Inisiaste sesión como:</div>
                    Administrador
                </div>
            </nav>
        </div>