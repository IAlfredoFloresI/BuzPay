            ...
            <div class="sb-sidenav-menu" style="background-color: #343A40;">
                <div class="nav">
                    ...
                    <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne"
                        ...
                        <a class="nav-link text-white" href="{{ route('recarga.empleados') }}">Recargar Tarjeta</a>
                            <a class="nav-link text-white" href="{{ route('tarjeta.empleados') }}">Consultar Datos Tarjeta</a>
                        </nav>
                    </div>
                    <a class="nav-link collapsed text-white" href="#" data-bs-toggle="collapse"
                    ...
                    <a class="nav-link text-white" href="{{ route('CierreCaja.empleados') }}">
                        <div class="sb-nav-link-icon text-white">
