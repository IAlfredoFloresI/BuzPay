...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
        <div class="container">
            <a class="navbar-brand" href="#page-top"><img src="assets/img/Camión_Icono.png" alt="PAYBUS" width="40" height="10" /></a>
    ...
    <header id="Inicio" class="masthead">
        <div class="container">
            <h4 id="TPAYBUS" class="masthead-heading text-uppercase display-4 fw-bold text-body-emphasis">Bienvenido a PAYBUS</h4>
                        ...
                        <ul class="menu MenuOp">
                            <li class="N">
                                <div>
                                    ...
                                    <a class="btn btn-primary btn-xl text-uppercase" href="#services" data-bs-toggle="modal" data-bs-target="#loginModal">Iniciar Sesión</a>
                                </div>
                            </li>
                            <li class="CS">
                                <div>
                                    ...
                                    <a class="btn btn-primary btn-xl text-uppercase" href="#contact" data-bs-target="#contact">Ir a consulta</a>
                                </div>
                            </li>
                        </ul>
                    </div>
    ...
    <main>
            ...
            <div class="container">
                ...
                <div class="row text-center">
                    <div class="col-md-12">
                        ...
                        <p class="text-muted">Somos un equipo universitario apasionado por la movilidad sostenible y la innovación tecnológica. Nuestro proyecto de recargas de transporte público busca facilitar la vida de los usuarios y contribuir a los negocios emergentes, ya sean negocios medianos y chicos, PAYBUS es un beneficio facil de utilizar para el usuario que usa el transporte público.</p>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                ...
                <div class="row text-center">
                    <div class="col-md-6">
                        ...
                        <p class="text-muted">Ser un software que brinda la transformación del método de pago del transporte público, utilizando tarjetas recargables.</p>
                    </div>
                    <div class="col-md-6">
                        <span class="fa-stack fa-4x">
                            <i class="fas fa-circle fa-stack-2x text-primary"></i>
                        ...
                        <p class="text-muted">Ser la primera empresa en abarcar este sistema a todos los estados de México, mediante la ampliación de las alternativas de recargas al público, dando lugar un sistema de recaudo eficiente, transparente y seguro.</p>
                    </div>
                </div>
            </div>
        </section>
                    ...
                    <div class="row align-items-stretch mb-5">
                        <div class="col-md-6">
                            <div class="form-group mb-md-0">
                                <input class="form-control" id="folio" type="text" placeholder="folio*" data-sb-validations="required" />
                                <div class="invalid-feedback" data-sb-feedback="phone:required">A phone number is required.</div>
                                <div class="text-center">
                                    <br>
                                    <button class="btn btn-primary btn-xl text-uppercase" type="button" onclick="consultarFolio()">Consultar</button>
                            ...
                            <div class="field">
                                ...
                                <input class="form-control" type="text" id="saldo" name="saldo" placeholder="Saldo actual" readonly>
                            </div>
                            <div class="field">
                                <label for="fecha-vencimiento">Fecha de Vencimiento de la Tarjeta:</label>
                                <input class="form-control" type="text" id="fecha-vencimiento" placeholder="Fecha de vencimiento" name="fecha-vencimiento" readonly>
                            </div>
                        </div>
                    </div>
                </form>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="registerForm" action="{{ route('register') }}" method="POST" onsubmit="return validateForm();">
                            ...
                            <div id="apellidoError" class="text-danger" style="display: none;">Debes ingresar al menos un apellido.</div>
        ...
        <script>
            function validateForm() {
                ...
                const curpRegex = /^([A-Z][AEIOU][A-Z]{2}[0-9]{2}(0[1-9]|1[0-2])(0[1-9]|[12][0-9]|3[01])[HM](AS|BC|BS|CC|CL|CM|CS|CH|DF|DG|GT|GR|HG|JC|MC|MN|MS|NT|NL|OC|PL|QT|QR|SP|SL|SR|TC|TL|TS|VZ|YN|ZS|NE)[B-DF-HJ-NP-TV-Z]{3}[0-9A-Z]\d)$/;
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-4 my-3 my-lg-0">
                    <a class="btn btn-dark btn-social mx-2" href="https://www.instagram.com/paybusutm?igsh=MWY3cnF0cGJ6bTB5Zw==" aria-label="Twitter"><i class="fab fa-instagram"></i></a>
                    <a class="btn btn-dark btn-social mx-2" href="https://www.facebook.com/profile.php?id=61561058630649&mibextid=ZbWKwL" aria-label="Facebook"><i class="fab fa-facebook-f"></i></a>
                </div>
